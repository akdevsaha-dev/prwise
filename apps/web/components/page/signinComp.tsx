    ...
    <motion.div
      ...
      <div className="mt-8">
        ...
        <div className="text-neutral-500 text-sm text-center mt-4">
          Don't have an account? <Link href={"/signup"} className="text-white/90 hover:underline hover:underline-offset-2">Sign up</Link> or <Link href={"/"} className="text-white/90 hover:underline hover:underline-offset-2">Learn more</Link>
        </div>
      </div>
    </motion.div>
  </div>
